...
type TemplateLine = { type: "section-title" | "paragraph"; text: string };
...
const SOAP_LINES: TemplateLine[] = [
  { type: "section-title", text: "Subjective" },
  { type: "section-title", text: "Chief Complaint" },
  { type: "paragraph", text: "[Patient's primary reason for visit]" },
  { type: "paragraph", text: "" },
  { type: "section-title", text: "History of Present Illness" },
  ...
  { type: "paragraph", text: "" },
  { type: "section-title", text: "Review of Systems" },
  ...
  { type: "paragraph", text: "" },
  { type: "section-title", text: "Social History" },
  ...
  { type: "paragraph", text: "" },
  { type: "section-title", text: "Family History" },
  { type: "paragraph", text: "[Relevant family medical history]" },
  { type: "paragraph", text: '(If not discussed, state "Not discussed")' },
  { type: "paragraph", text: "" },
  { type: "section-title", text: "Objective" },
  { type: "section-title", text: "Physical Examination" },
  { type: "section-title", text: "Vital Signs:" },
...
const HP_LINES: TemplateLine[] = [
  { type: "section-title", text: "Patient Information" },
  ...
  { type: "paragraph", text: "" },
  { type: "section-title", text: "Assessment and Plan" },
...
const PROGRESS_NOTE_LINES: TemplateLine[] = [
  { type: "section-title", text: "Progress Note" },
...
const DC_SUMMARY_LINES: TemplateLine[] = [
  { type: "section-title", text: "Discharge Summary" },
  ...
  { type: "paragraph", text: "" },
  { type: "section-title", text: "Admitting Diagnosis" },
  { type: "paragraph", text: "[Primary reason for admission]" },
  { type: "paragraph", text: "" },
  { type: "section-title", text: "Discharge Diagnosis" },
  ...
  { type: "paragraph", text: "" },
  { type: "section-title", text: "Hospital Course" },
  ...
  { type: "paragraph", text: "" },
  { type: "section-title", text: "Procedures Performed" },
  { type: "paragraph", text: "[List all procedures with dates]" },
  { type: "paragraph", text: "" },
  { type: "section-title", text: "Consultations" },
  { type: "paragraph", text: "[Consulting services and key recommendations]" },
  { type: "paragraph", text: "" },
  { type: "section-title", text: "Significant Labs/Studies" },
  { type: "paragraph", text: "[Key diagnostic results]" },
  { type: "paragraph", text: "" },
  { type: "section-title", text: "Discharge Condition" },
  ...
  { type: "paragraph", text: "" },
  { type: "section-title", text: "Discharge Medications" },
  ...
  { type: "paragraph", text: "" },
  { type: "section-title", text: "Follow-up" },
  ...
  { type: "paragraph", text: "" },
  { type: "section-title", text: "Patient Instructions" },
...
const PROCEDURE_NOTE_LINES: TemplateLine[] = [
  { type: "section-title", text: "Procedure Note" },
  ...
  { type: "paragraph", text: "" },
  { type: "section-title", text: "Indication" },
  { type: "paragraph", text: "[Clinical reason for procedure]" },
  { type: "paragraph", text: "" },
  { type: "section-title", text: "Consent" },
  { type: "paragraph", text: "[Informed consent obtained; risks, benefits, alternatives discussed]" },
  { type: "paragraph", text: "" },
  { type: "section-title", text: "Pre-Procedure Assessment" },
  { type: "section-title", text: "Vital Signs:" },
  { type: "paragraph", text: "BP: [Blood pressure]" },
  { type: "paragraph", text: "HR: [Heart rate]" },
  { type: "paragraph", text: "SpO2: [Oxygen saturation]" },
  { type: "paragraph", text: "" },
  { type: "section-title", text: "Anesthesia/Sedation" },
  { type: "paragraph", text: "[Type and amount of anesthesia/sedation used]" },
  { type: "paragraph", text: "" },
  { type: "section-title", text: "Procedure Details" },
...
const CONSULTATION_NOTE_LINES: TemplateLine[] = [
  ...
  { type: "paragraph", text: "" },
  { type: "section-title", text: "Reason for Consultation" },
  ...
  { type: "paragraph", text: "" },
  { type: "section-title", text: "Pertinent Past Medical History" },
  { type: "paragraph", text: "[Relevant to consultation question]" },
  { type: "paragraph", text: "" },
  { type: "section-title", text: "Current Medications" },
  { type: "paragraph", text: "[Medications relevant to consultation]" },
  { type: "paragraph", text: "" },
  { type: "section-title", text: "Allergies" },
  { type: "paragraph", text: "[Drug allergies]" },
  { type: "paragraph", text: "" },
  { type: "section-title", text: "Pertinent Review of Systems" },
...
const DAP_LINES: TemplateLine[] = [
  { type: "section-title", text: "DAP Note" },
